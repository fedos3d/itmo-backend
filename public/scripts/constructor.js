...
//Monday:
const monday = [];
let Linux = new Zan(new StudyTime("8:20", "9:50"), WeekType.even, "325",
...
monday.push(Linux);
const weekdays = [];
weekday = new WorkDay(WeekdaysRU.Monday, monday);

Linux = new Zan(new StudyTime("10:00", "11:30"), WeekType.even, '325',
    'Администрирование в ОС Linux/Linux operating system administration', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Шараева Кристина Витальевна', 'M33031');
monday.push(Linux);
let ML = new Zan(new StudyTime("11:40", "13:10"), WeekType.all, "285",
  "Машинное обучение", "Лекции",
  "Очно - дистанционный ", "Хлопотов Максим Валерьевич", "M33031");
monday.push(ML);
let WEB = new Zan(new StudyTime("13:30", "15:00"), WeekType.odd, "236",
  "Web-программирование", "Лабораторные занятия",
  "Очно - дистанционный ", "-", "M33031");
monday.push(WEB);
WEB = new Zan(new StudyTime("15:20", "16:50"), WeekType.odd, '236',
    'Web-программирование', 'Лабораторные занятия',
    'Очно - дистанционный ', '-', 'M33031');
monday.push(WEB);
...
const wednesday = [];
weekday = new WorkDay(WeekdaysRU.Wednesday, wednesday);
WEB = new Zan(new StudyTime("11:40", "13:10"), WeekType.all, '100/1(усл) ',
    'Web-программирование', 'Лекции',
    'Очно - дистанционный ', 'Приискалов Роман Андреевич', 'M33031');
wednesday.push(WEB);
ML = new Zan(new StudyTime("13:30", "15:00"), WeekType.odd, '239',
    'Машинное обучение', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Хлопотов Максим Валерьевич', 'M33031');
wednesday.push(ML);
ML = new Zan(new StudyTime("15:20", "16:50"), WeekType.odd, '239',
    'Машинное обучение', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Хлопотов Максим Валерьевич', 'M33031');
wednesday.push(ML);
weekdays.push(weekday);
...
const thursday = [];
weekday = new WorkDay(WeekdaysRU.Thursday, thursday);
EN = new Zan(new StudyTime("08:20", "09:50"), WeekType.all, '3212',
...
thursday.push(EN);
EN = new Zan(new StudyTime("10:00", "11:30"), WeekType.all, '3212',
    'Иностранный язык в профессиональной деятельности', 'Практические занятия',
    'Очно - дистанционный ', 'Немец Мария Сергеевна', 'АЯ-3IT-C2/1');
thursday.push(EN);
Linux = new Zan(new StudyTime("13:30", "15:00"), WeekType.all, '100/1(усл) ',
...
thursday.push(Linux);
UML = new Zan(new StudyTime("15:20", "16:50"), WeekType.all, '331',
...
const friday = [];
weekday = new WorkDay(WeekdaysRU.Friday, friday);
UML = new Zan(new StudyTime("10:00", "11:30"), WeekType.odd, '236',
    'Анализ и проектирование на UML', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Хлопотов Максим Валерьевич', 'M33031');
friday.push(UML);
UML = new Zan(new StudyTime("11:40", "13:10"), WeekType.odd, '236',
    'Анализ и проектирование на UML', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Хлопотов Максим Валерьевич', 'M33031');
friday.push(UML);
let HISTORY = new Zan(new StudyTime("11:40", "13:10"), WeekType.even, "332",
  "История (Наука и техника в истории цивилизации)", "Лекции",
  "Очно - дистанционный ", "Васильев Андрей Владимирович", "ИНТ 6");
friday.push(HISTORY);
HISTORY = new Zan(new StudyTime("13:30", "15:00"), WeekType.even, '429',
...
const saturday = [];
weekday = new WorkDay(WeekdaysRU.Saturday, saturday);
let PRIMAT = new Zan(new StudyTime("11:40", "13:10"), WeekType.even, "3408",
  "Прикладная математика", "Лекции",
  "Очно - дистанционный ", "Москаленко Мария Александровна", "M33031");
saturday.push(PRIMAT);
PRIMAT = new Zan(new StudyTime("13:30", "15:00"), WeekType.even, '2202',
    'Прикладная математика', 'Лекции',
    'Очно - дистанционный ', 'Москаленко Мария Александровна', 'M33031');
saturday.push(PRIMAT);
PRIMAT = new Zan(new StudyTime("15:20", "16:50"), WeekType.odd, '1513',
    'Прикладная математика', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Москаленко Мария Александровна', 'M33031');
saturday.push(PRIMAT);
PRIMAT = new Zan(new StudyTime("17:00", "18:30"), WeekType.odd, '1513',
    'Прикладная математика', 'Лабораторные занятия',
    'Очно - дистанционный ', 'Москаленко Мария Александровна', 'M33031');
saturday.push(PRIMAT);
weekdays.push(weekday);
...
function formsubmit() {
    ...
    const checkedBoxes = document.querySelectorAll("input[name=column]:checked");
    const checked = [];
...
function drawTable(lang, days, storedChecks) {
    ...
    for (let i = 0; i < days && i < weekdays.length; i++) {
        let j;
        ...
        for (j = 0; j < storedChecks.length; j++) {
        ...
        for (j = 0; j < weekdays[i].classes.length; j++) {
...
function tickChecked () {
    const arr = loadLocalStorageData();
    lang = arr[0];
    days = arr[1];
    storedChecks = arr[2];
